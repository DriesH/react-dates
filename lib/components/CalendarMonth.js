    ...
    value: function () {
      function render() {
        var _props = this.props,
            enableDropdowns = _props.enableDropdowns,
            month = _props.month,
        ...
        return _react2['default'].createElement(
          ...
          _react2['default'].createElement(
            ...
            _react2['default'].createElement(_MonthSelector2['default'], { month: month, onYearSelect: onYearSelect, onMonthSelect: onMonthSelect })
          ),
          _react2['default'].createElement(
            'table',
            _extends({}, (0, _reactWithStyles.css)(styles.CalendarMonth_table), { role: 'presentation' }),
            _react2['default'].createElement(
              'tbody',
              { ref: this.setGridRef },
